...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'brotherdog@mail.ustc.edu.cn',
  ...
  email: 'mailto:yanyaa38@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/zxmacc/onedrive-vercel-index',
    },
  ],
